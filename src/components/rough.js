<div className='  h-full w-full bg-[#0F172A]'>
    <div className="about-arun py-12 px-8 bg-[#0F172A] text-white ">
        ...
        <ul className="achievements list-disc space-y-2 text-[#06b6d4] ml-10">
        ...
        <div className="bg- hero min-h-screen flex flex-col justify-center items-center bg-cover bg-no-repeat bg-center bg-[#0F172A]" style={{ backgroundImage: "url('./images/hero-banner.jpg')" }}>
            <h2 className="text-4xl font-bold text-white mb-8">Empower Your Voice. Become a Journalist.</h2>
            <p className="text-xl text-white text-center mb-10">Learn from a renowned journalist. Practical online course for aspiring journalists.</p>
            {/* <a href=" " className="px-4 py-2 bg-blue-500 text-white font-bold rounded hover:bg-blue-700">Enroll Now</a> */}
            <h2>The 2-Week Online Course</h2>
            <p className="text-lg mb-6">This comprehensive course will equip you with the practical skills...</p>
            ...
            <ul className="course-benefits list-disc space-y-2 mt-6">
                <li>Learn from a renowned journalist</li>
                <li>Gain practical skills and insights</li>
                <li>Flexible learning schedule</li>
                <li>Supportive online community</li>
            </ul>
            <a href=" " className="px-4 py-2 mt-8 bg-blue-500 text-white font-bold rounded hover:bg-blue-700">Enroll Now</a>
    ...
    <div className="course-details py-12 px-8     text-white  bg-[#0F172A]">
